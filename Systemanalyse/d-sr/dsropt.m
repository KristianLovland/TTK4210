...
%2. %%% Compute the Kalman filter gain if it exist, i.e. F non-singular %%

% This step should be used with care when F is close to singular,
% i.e., for (nearly) deterministic systems, for systems without noise. 
c=cf*inv(f);

%3. %%% Simulate the optimal predictor %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[yp,xp]=dsrsim(a-c*d,[b-c*e,c],d,[e,zeros(m,m)],[U,Y],x0);
